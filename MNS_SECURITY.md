...
## 1.1 Defensive Design Summary (Hardening)
...
- **Future hardening roadmap** (AEAD, signature verification policies, additional anti-flood): see **§9**

This section is intentionally high-level to avoid duplicating the detailed design below.
